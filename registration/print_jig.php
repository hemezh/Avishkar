...
$info = getUserByAKID("AK11".$row['stu_id']);
		...
		echo "<tr><td width='60%'><B>Avishkar ID: </b>";
		echo "<br /><b>Name: </b><br />";
		echo "<b>School Name: </b><br /><b>Contact No.:</b><br /><b>Faculty Name:</b><br /><b>Faculty Contact no.:</b></td>";
		echo "<td><center><div style='border-color:#000; border-width:thin; border-style:solid; width:50px; height:70px;'></div></center></td></tr>";
		echo "<tr><td><img src='jolt.jpg' /></td><td><center>----------------<br />Avishkar 2011</center></td></tr>";
