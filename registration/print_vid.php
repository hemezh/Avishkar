...
<?php
$data="select * from volunteer where `icard`=\"0\"";
...
{
	$data = "update volunteer set icard = \"1\" where stu_id = \"".$row['stu_id']."\" " ; 
...
$info = getUserByAKID("AK11".$row['stu_id']);
		...
		echo "<tr><td colspan='2'><center><img width='250px' src='avi.jpg' /><br />Volunteer iCard</center></td></tr>";
		echo "<tr><td width='60%'><B>Avishkar ID: </b>AK11".$row['stu_id']." ";
		echo "<br /><b>Name: </b>".$info['name']."<br />";
		echo "<b>Field: </b>".$row['field'] ;
		//echo "<b>Branch: </b>".$info['prog']."<br /><b>College:</b>".$info['college'];
		echo "</td>";
		echo "<td><center>" ;
		echo "<div style='border-color:#000; border-width:thin; border-style:solid; width:40px; height:50px;'></div>";
		//echo "<img src=\"./jolts.jpg\" width=\"50px\" height=\"50px\" />" ;
		echo "</center></td></tr>";
