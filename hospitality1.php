...
<div id="main">
 <table border="0" width="100%">
		...
		<p align="center" style="font-weight:bolder; font-size:16px; background-color:#072330; color:#F0F0F0; box-shadow:0 0 10px black inset; font-family:'Lucida Sans Unicode','Lucida Grande',sans-serif; opacity:0.95" >Prizes worth 3 Lakhs to be won !!!</p>	
        </div></div>
        </td>
